          ...
          <div className="w-[100%] h-[500px] flex flex-col-reverse overflow-hidden">
            ...
            <Input id="quantity" onKeyDown={(e) => {
              if (e.key === "Enter") {
                ...
                newData.splice(0, 0, "Looking at your data over the past two weeks, you tend to overproduce on Tuesdays, you can increase your efficacy by 30% by reducing your production");
